...
- Registro em planilha própria (aba `Manifestacoes`, criada automaticamente).
...
6. Isso cria automaticamente:
   - a aba **Manifestacoes** na planilha (com cabeçalho);
...
Esses campos aparecem no formulário, na planilha (`Manifestacoes`), no e-mail
